...
class MyProject:
    def __init__(self, master):
        ...
        self.label2 = Label(self.tf, text='Welcome to Indian Palace Restaurant! ', font=(
            'Courier', 18, 'bold'), bg='orange')
        ...
        self.button = Button(self.tf, text=" Management Login", font=(
            'Algerian', 12, 'bold'), command=self.mLogin)
        ...
        self.label4 = Label(self.tf, text='''Ove Road, Sector 35-D, Kharghar, Navi Mumbai ''',
                            font=('Courier', 12), bg='orange', anchor=W)
        self.label4.place(x=325, y=400)
        self.label5 = Label(self.tf, text="Address", font=(
            'Courier', 12), bg='orange', anchor=NW)
        self.label5.place(x=325, y=375)
        self.l6 = Label(self.tf, text="Contact No\n9769038259",
                        font=('Courier', 12), bg='orange', justify=LEFT)
...
class PlaceOrder():
    def __init__(self, master, logo):
        ...
        self.label2 = Label(self.tf, text='Order placement of Indian Palace restaurant', font=('Courier', 18, 'bold'),
                            bg='orange', anchor=E)
        self.label2.grid(row=1, column=1, columnspan=5)
        # Labels of Meal

        self.m1 = Label(self.lf, text="Meals", font=(
            'Courier', 16, 'bold'), bg='orange', justify="center")
        self.m1.place(x=25, y=0)

        self.v1 = IntVar()
        self.c1 = Checkbutton(self.lf, text="Veg Kolhapuri", font=(
            'Courier', 11, 'bold'), bg='orange', variable=self.v1)
        self.c1.place(x=10, y=50)

        self.v2 = IntVar()
        self.c2 = Checkbutton(self.lf, text="Veg Hydrabadi", font=('Courier', 11, 'bold'), bg='orange',
                              variable=self.v2)
        ...
        self.v10 = IntVar()
        self.c10 = Checkbutton(self.lf, text="Veg Biryani", font=('Courier', 11, 'bold'), bg='orange',
                               variable=self.v10)
        ...
        self.cl1 = Label(self.rf, text="Customer details",
                         font=('Courier', 18, 'bold'), bg='orange')
        ...
        self.cl4 = Label(self.rf, text="Mobile no.", font=(
            'Courier', 11, 'bold'), bg='orange')
        ...
        if self.ce1.get() == "" or self.ce2.get('1.0', END) == "" or self.ce3.get() == "":
            ...
            if ans > 0:
                ...
                messagebox.showinfo(parent=self.m, message="Order placed\n Customer ID:"+str(
                    cust_id), title="Indian Palace Restaurant")
                self.reset()
